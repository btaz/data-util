...
public class XmlReaderTest {
    ...
    public void testOfFindAndReadShouldFindDocument() throws Exception {
        ...
        // when
        boolean result = reader.find("/things/metals/gold");
        Document doc = reader.read("/things/metals/gold");
        reader.close();
    ...
    public void testOfFindAndMultipleReadsShouldRetrieveDocuments() throws Exception {
        ...
        Document doc2 = reader.read("*");
        Document doc3 = reader.read("*");
        Document doc4 = reader.read("*");
        Document doc5 = reader.read("*");
        Document doc6 = reader.read("*");
        Document doc7 = reader.read("*");
