...
import com.btaz.util.xml.model.querypath.PathQueryParser;

import java.util.List;

/**
 * This object represent an XML document.
 * User: msundell
 */
public class Xml implements Cloneable {
    ...
    /**
     * Get the root element for this {@code Xml}
     * @return {@code Element}
     */
    ...
    /**
     * Add a new XML fragment to this {@code Xml}
     * @return {@code Xml} so that you can easily chain adds
     */
    public Xml addElement(String xmlFragment) {
        Element element = elementBuilder.getElement(xmlFragment);
        return addElement(element);
    }

    /**
     * Add a new {@code Element} to this {@code Xml}
     * @return {@code Xml} so that you can easily chain adds
     */
     ...
     * </pre>
     * @return {@code Xml} instance
     */
    public Xml endElement() {
     ...
     * @return {@code Xml}
     */
    public Xml addContent(String text) {
        if(current == null) {
     ...
     * @return {@code Xml}
     */
    public Xml addContent(Content content) {
        if(current == null) {
    ...
    public boolean equals(Object anObject) {
        ...
        Xml xml = (Xml) anObject;

        //noinspection RedundantIfStatement
        if(! bfsComparison(root, xml.root)) {
            return false;
        }
     ...
     * @return {@code Object} the cloned {@code Xml} instance
     * @throws CloneNotSupportedException
     */
    @Override
    public Object clone() throws CloneNotSupportedException {
        super.clone();
        Xml doc = new Xml(name);
        if(root != null) {
